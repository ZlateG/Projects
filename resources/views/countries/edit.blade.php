            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="justify-center flex">
                    <div class="child">
                        ...
                        <h2 class="text-lg text-blue-500 bg-green-100 text-center p-3 mb-5">Edit Country</h2>
                        @if(session('success'))
                        ...
                        <form action="{{ route('countries.update', ['id' => $country->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <x-input id="country_name" value="{{ $country->country_name }}"  class="mb-5 block mt-1 w-full" type="text" name="country_name" />
