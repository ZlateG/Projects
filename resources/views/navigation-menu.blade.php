        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('editor.subscribers') }}" :active="request()->routeIs('editor.subscribers')">
                        {{ __('Subscribers') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('testimonials.index') }}" :active="request()->routeIs('testimonials.index')">
                        {{ __('Testimonial') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('moments.index') }}" :active="request()->routeIs('moments.index')">
                        {{ __('Your Moments') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('destinations.index') }}" :active="request()->routeIs('destinations.index')">
                        {{ __('Destination') }}
                    </x-nav-link>
                    @can('manage-employee') <!-- This checks if the user has the 'manage-employee' permission -->
